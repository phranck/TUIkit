...
/* Modified by TUIkit: report extraneous entropy-coded data as invalid padding. */
...
extension JPEG
{
    ...
    enum DecodingError:JPEG.Error
    {
        ...
        case truncatedEntropyCodedSegment
        /// An entropy-coded segment contained more than seven padding bits or non-one padding bits.
        case invalidEntropyCodedSegmentPadding
        ...
        var message:String
        {
            ...
            case .invalidEntropyCodedSegmentPadding:
                return "invalid entropy coded segment padding"
        ...
        var details:String?
        {
            ...
            case .invalidEntropyCodedSegmentPadding:
                return "entropy coded segment must end with at most seven one-padding bits"
