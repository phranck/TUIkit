// Modified by TUIkit: renamed an internal module import and reject reserved PNG scanline filters.

import TUIkitVendorLZ77
...
extension PNG.Decoder
{
        ...
        if let pass:Int = self.pass
        {
            for z:Int in pass ..< 7
            {
                ...
                for y:Int in start ..< subimage.y
                {
                    ...
                    try Self.defilter(&scanline, last: last, delay: delay)
    ...
    static
    func defilter(_ line:inout [UInt8], last:[UInt8], delay:Int) throws
    {
        ...
        case let filter:
            throw PNG.DecodingError.invalidScanlineFilter(filter)
        }
    }
}
