// Modified by TUIkit: report reserved PNG scanline filter values.
...
extension PNG
{
    ...
    enum DecodingError
    {
        ...
        /// A decompressed scanline begins with a reserved filter value.
        case invalidScanlineFilter(UInt8)
    }
}
extension PNG.DecodingError:PNG.Error
{
    ...
    var details:String?
    {
        ...
        case    .incompleteImageDataCompressedDatastream,
                ...
                .extraneousImageData:
            return nil
        case .invalidScanlineFilter(let filter):
            return "scanline filter \(filter) is outside the valid range 0...4"
