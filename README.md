<p align="center">
    ...
    <img alt="Tests" src="https://img.shields.io/badge/Tests-1255_passing-005c00">
</p>
...
Test discovery covers 1255 tests across all isolated targets.
...
- All 1255 tests run through Swift Testing; suites that isolate shared state run serially
