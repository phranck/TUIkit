<p align="center">
    ...
    <img alt="Tests" src="https://img.shields.io/badge/Tests-1312_passing-005c00">
</p>
...
Test discovery covers 1312 tests across all isolated targets.
...
- All 1312 tests run through Swift Testing; suites that isolate shared state run serially
