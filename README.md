<p align="center">
    ...
    <img alt="Tests" src="https://img.shields.io/badge/Tests-1305_passing-005c00">
</p>
...
- All 1305 tests run through Swift Testing; suites that isolate shared state run serially
